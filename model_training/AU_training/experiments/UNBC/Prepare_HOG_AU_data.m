...
if(numel(train_users) > 0)
    ...
    train_appearance_data = train_appearance_data(valid_ids_train_hog,:);
    train_geom_data = train_geom_data(valid_ids_train_hog,:);
    vid_ids_train_string = vid_ids_train_string(valid_ids_train_hog,:);
end
%% Extract devel data
