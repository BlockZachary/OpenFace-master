...
unbc_loc = 'E:\New_OpenFace\Datasets\UNBC\Images';
...
tab = readtable([out_loc, '042-ll042_ll042t1aaaff.au.csv']);
...
for i=1:numel(filenames)
    ...
    fname = dir([out_loc, '/*', filenames{i}, '.au.csv']);
    fname = fname(1).name;
